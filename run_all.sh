...
./build.out "/media/jpcastillog/Respaldo 1/PISA/CC-News/cc-news.docs" --min_size 1 --rank v --runs t --out "/media/jpcastillog/Respaldo 2/data/CC-News/cc-news_rank_v_runs_t.bin"
