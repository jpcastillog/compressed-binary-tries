...
# ./queries.out "/media/jpcastillog/Nuevo vol/data/Gov2Flat/gov2_rank_v5_runs_t.bin" "/media/jpcastillog/Nuevo vol/data/Gov2Flat/1mq.txt" --#sequences 1107204 --rank v5 --runs t
...
# ./queries.out "/media/jpcastillog/Nuevo vol/data/Gov2Flat/gov2_rank_v5_runs_t2.bin" "/media/jpcastillog/Nuevo vol/data/Gov2Flat/1mq.txt" --#sequences 1107205 --rank v5 --runs t --out "/media/jpcastillog/Nuevo vol/data/Resultados/gov2_rank_v5_runs_t_results.csv"
# ./queries.out "/media/jpcastillog/Nuevo vol/data/Gov2Flat/gov2_rank_v_runs_t.bin" "/media/jpcastillog/Nuevo vol/data/Gov2Flat/1mq.txt" --#sequences 1107204 --rank v --runs t --out "/media/jpcastillog/Nuevo vol/data/Resultados/gov2_rank_v_runs_t_results.csv"
# ./queries.out "/media/jpcastillog/Nuevo vol/data/Gov2Flat/gov2_rank_il_512_runs_t.bin" "/media/jpcastillog/Nuevo vol/data/Gov2Flat/1mq.txt" --#sequences 1107204 --rank il 512 --runs t --out "/media/jpcastillog/Nuevo vol/data/Resultados/gov2_rank_il_512_runs_t_results.csv"
# ./queries.out "/media/jpcastillog/Nuevo vol/data/Gov2Flat/gov2_rank_il_256_runs_t.bin" "/media/jpcastillog/Nuevo vol/data/Gov2Flat/1mq.txt" --#sequences 1107204 --rank il 256 --runs t --out "/media/jpcastillog/Nuevo vol/data/Resultados/gov2_rank_il_256_runs_t_results.csv"

# ./queries.out "/media/jpcastillog/Nuevo vol/data/ClueWeb09Flat/clueweb09_rank_v5_runs_t.bin" "/media/jpcastillog/Nuevo vol/data/ClueWeb09Flat/1mq.txt" --#sequences 1000000 --rank v5 --runs t --out "/media/jpcastillog/Nuevo vol/data/Resultados/clueweb09_rank_v5_runs_t_results.csv"
# ./queries.out "/media/jpcastillog/Nuevo vol/data/ClueWeb09Flat/clueweb09_rank_v_runs_t.bin" "/media/jpcastillog/Nuevo vol/data/ClueWeb09Flat/1mq.txt" --#sequences 1000000 --rank v --runs t --out "/media/jpcastillog/Nuevo vol/data/Resultados/clueweb09_rank_v_runs_t_results.csv"
# ./queries.out "/media/jpcastillog/Nuevo vol/data/ClueWeb09Flat/clueweb09_rank_il_512_runs_t.bin" "/media/jpcastillog/Nuevo vol/data/ClueWeb09Flat/1mq.txt" --#sequences 1000000 --rank il 512 --runs t --out "/media/jpcastillog/Nuevo vol/data/Resultados/clueweb09_rank_il_512_runs_t_results.csv"
# ./queries.out "/media/jpcastillog/Respaldo 2/data/ClueWeb09Flat/clueweb09_rank_il_256_runs_t.bin" "/media/jpcastillog/Respaldo 2/data/ClueWeb09Flat/1mq.txt" --#sequences 1000000 --rank il 256 --runs t --out "/media/jpcastillog/Nuevo vol/data/Resultados/clueweb09_rank_il_256_runs_t_results.csv"
